...
export const WhyUsSection: FC = () => {
  return (
    <section className="u-black u-clearfix u-section-5" id="sec-5e11">
      <div className="u-clearfix u-sheet u-sheet-1">
        <div 
          className="u-align-center u-container-style u-expanded-width-xs u-group u-group-1"
          data-aos="fade-up"
          data-aos-delay="0"
        >
          <div className="u-container-layout u-valign-middle u-container-layout-1">
            <h2 className="u-custom-font u-font-oswald u-text u-text-1">Why Us?</h2>
            <p className="u-text u-text-2">Your ingenious ideas. Our state-of-the-art approach and goal oriented focus.</p>
          </div>
        </div>
          ...
          <div className="u-layout">
            <div className="u-layout-col">
              ...
              <div className="u-size-30">
                <div className="u-layout-row">
                  <div 
                    className="u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-3"
                    data-aos="fade-up"
                    data-aos-delay="260"
                  >
                    <div className="u-container-layout u-valign-middle-xs">
                      <span className="u-icon u-icon-circle u-icon-3">
                        <svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 -32 512 512" style={{}}><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-4f6d"></use></svg>
                        <svg className="u-svg-content" viewBox="0 -32 512 512" id="svg-4f6d">
                          <path d="m7.375 16.781 1.25-1.562L4.601 12l4.024-3.219-1.25-1.562-5 4a1 1 0 0 0 0 1.562l5 4zm9.25-9.562-1.25 1.562L19.399 12l-4.024 3.219 1.25 1.562 5-4a1 1 0 0 0 0-1.562l-5-4zm-1.649-4.003-4 18-1.953-.434 4-18z"></path>
                        </svg>
                      </span>
                      <h3 className="u-custom-font u-font-oswald u-text u-text-7">Professional Trainings</h3>
                      <p className="u-text u-text-8">We offer an educational packages, where we broaden the knowledge of your employees. We can teach them how to use new processes, write test scripts based on the UML diagrams, decide which input parameters to test and so much more.</p>
                    </div>
                  </div>
                  <div 
                    className="u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-4"
                    data-aos="fade-up"
                    data-aos-delay="340"
                  >
                    <div className="u-container-layout">
                      <span className="u-icon u-icon-circle u-icon-4">
                        <svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style={{}}><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-ed82"></use></svg>
                        <svg className="u-svg-content" viewBox="0 0 512 512" id="svg-ed82">
                          <g><circle cx="338.833" cy="173.833" r="7.5"></circle><circle cx="368.833" cy="173.833" r="7.5"></circle><circle cx="308.833" cy="173.833" r="7.5"></circle></g>
                        </svg>
                      </span>
                      <h3 className="u-custom-font u-font-oswald u-text u-text-9">English Lectures</h3>
                      <p className="u-text u-text-10">We offer lectures focused on grammar, vocabulary, speaking, reading, debating based on the needs of your employees. We can also provide translations of documents.</p>
                    </div>
                  </div>
                </div>
              </div>
